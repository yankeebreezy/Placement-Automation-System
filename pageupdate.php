...
<div id="container">
    ...
    <div id="nav">
    	<ul class="sf-menu dropdown">
        	<li><a href="page.html">Home</a></li>
             ...
             <li class="selected"><a href="pageupdate.php">Update</a></li>
	...
	<table width="629" border="0" align="center">
     ...
     <tr>
	  ...
	  <input type="submit" class="btnLogin" value="Update" tabindex="4">
	</footer>&nbsp;</td>
       </tr>
   </table>
   </form> </p>
