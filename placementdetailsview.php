...
<!-- content begins -->
  ...
  <div id="content" class="style8">
	...
	<p>&nbsp;</p>
	<p>&nbsp;</p>
	<p class="style26">Placement Details View </p>
	<p>&nbsp;</p>
	
	<table width="905" border="0" class="center">
  
  <tr>
    <td width="452" height="24"><form action="pdetailsview.php" method="POST" target="ifrm">
      <table width="336" border="0">
        <tr>
          <td width="166"><span class="style37">Enter the Year </span></td>
          <td width="12"><span class="style38">:</span></td>
          <td width="144" bgcolor="#DDDDDD"><label>
        ...
        <tr>
          <td height="32" colspan="3"><footer>
              <p>&nbsp;                </p>
              <p>
                <input name="submit" type="submit" class="btnLogin" tabindex="4" value="View" />
                </p>
          </footer>
            &nbsp;</td>
        </tr>
    ...
    <td width="439"><iframe  id=ifrm name=ifrm frameborder=0 width="100%" scrolling=yes  height=350>
	</iframe></td>
  </tr>
  <tr>
    <td></td>
