...
<div id="container">
    ...
    <div id="nav">
    	<ul class="sf-menu dropdown">
            ...
            <li class="selected"><a class="has_submenu">View</a>
            	<ul>
...
$result = @mysql_query('SELECT name FROM student WHERE DEPT = "CIVIL" ORDER BY name ASC');
if (!$result) {
...
$result = @mysql_query('SELECT regno FROM student WHERE DEPT = "CIVIL" ORDER BY name ASC');
if (!$result) {
exit('<p>Error performing query: ' .
mysql_error() . '</p>');
}
